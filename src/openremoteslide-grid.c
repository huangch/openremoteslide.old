...
struct grid_ops {
  void (*get_bounds)(struct _openremoteslide_grid *grid,
                     struct bounds *bounds);
  bool (*paint_region)(struct _openremoteslide_grid *grid,
                       cairo_t *cr, void *arg,
                       double x, double y,
                       struct _openremoteslide_level *level,
                       int32_t w, int32_t h,
                       GError **err);
  void (*destroy)(struct _openremoteslide_grid *grid);
};

typedef bool (*read_tiles_callback_fn)(struct _openremoteslide_grid *grid,
...
struct simple_grid {
  struct _openremoteslide_grid base;
...
static void compute_region(struct _openremoteslide_grid *grid,
                           double x, double y,
                           int32_t w, int32_t h,
                           struct region *region) {
  region->x = x;
...
static void simple_get_bounds(struct _openremoteslide_grid *_grid,
                              struct bounds *bounds) {
...
static bool simple_read_tile(struct _openremoteslide_grid *_grid,
  ...
  if (_openremoteslide_debug(OPENREMOTESLIDE_DEBUG_TILES)) {
...
static bool simple_paint_region(struct _openremoteslide_grid *_grid,
                                cairo_t *cr,
                                void *arg,
                                double x, double y,
                                struct _openremoteslide_level *level,
...
static void simple_destroy(struct _openremoteslide_grid *_grid) {
  struct simple_grid *grid = (struct simple_grid *) _grid;
...
struct _openremoteslide_grid *_openremoteslide_grid_create_simple(openremoteslide_t *osr,
  ...
  return (struct _openremoteslide_grid *) grid;
}
...
static void tilemap_get_bounds(struct _openremoteslide_grid *_grid,
                               struct bounds *bounds) {
...
static bool tilemap_read_tile(struct _openremoteslide_grid *_grid,
                              struct region *region,
                              cairo_t *cr,
                              struct _openremoteslide_level *level,
                              int64_t tile_col, int64_t tile_row,
  ...
  bool success = grid->read_tile(grid->base.osr, cr, level,
                                 ...
                                 arg, err);
  if (success && _openremoteslide_debug(OPENREMOTESLIDE_DEBUG_TILES)) {
    char *coordinates = g_strdup_printf("%"PRId64", %"PRId64,
                                        tile_col, tile_row);
...
static bool tilemap_paint_region(struct _openremoteslide_grid *_grid,
                                 cairo_t *cr,
                                 void *arg,
                                 double x, double y,
                                 struct _openremoteslide_level *level,
...
static void tilemap_destroy(struct _openremoteslide_grid *_grid) {
  struct tilemap_grid *grid = (struct tilemap_grid *) _grid;
...
void _openremoteslide_grid_tilemap_add_tile(struct _openremoteslide_grid *_grid,
...
static void range_get_bounds(struct _openremoteslide_grid *_grid,
                             struct bounds *bounds) {
...
static bool range_paint_region(struct _openremoteslide_grid *_grid,
                               cairo_t *cr,
                               void *arg,
                               double x, double y,
                               struct _openremoteslide_level *level,
  ...
  // ensure _openremoteslide_grid_range_finish_adding_tiles() was called
...
static void range_destroy(struct _openremoteslide_grid *_grid) {
  struct range_grid *grid = (struct range_grid *) _grid;
...
void _openremoteslide_grid_draw_tile_info(cairo_t *cr, const char *fmt, ...) {
  if (!_openremoteslide_debug(OPENREMOTESLIDE_DEBUG_TILES)) {
    return;
  }
